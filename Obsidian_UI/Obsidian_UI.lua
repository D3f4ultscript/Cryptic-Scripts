...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        local TitleIconWidth = WindowInfo.Icon and (WindowInfo.IconSize.X.Offset + 6) or 0
        local TitleHolderWidth = TitleHolder.AbsoluteSize.X / Library.DPIScale
        local TitleWidthScale = TitleHolderWidth > 0
            and math.clamp((TitleHolderWidth - TitleIconWidth - 12) / TitleHolderWidth, 0, 1)
            or 1
